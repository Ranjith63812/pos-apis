...
export default function SalesReturns() {
  ...
  const handleDelete = async () => {
    await deleteSalesReturn(deleteTarget.sale_return_id);
    setDeleteTarget(null); load();
  };

  const columns = [
    { key: 'sales_date', label: 'Return Date' },
    ...
    <>
      <section className="content-header p-3 pb-0 d-flex justify-content-between align-items-center mb-3">
        <h1 className="m-0 fs-3 fw-normal" style={{ color: '#333' }}>
          Sales Returns List <small className="text-muted fs-6 ms-2">View/Search Returned Items</small>
        </h1>
          ...
          <div className="box-body p-4 bg-white">
            <div className="row g-3 d-flex align-items-end mb-4">
               <div className="col-md-2 offset-md-10 text-end">
                <Link to="/sales-returns/new" className="btn btn-info text-white rounded-0 d-inline-flex gap-1 align-items-center" style={{ backgroundColor: '#00c0ef', borderColor: '#00acd6' }}>
